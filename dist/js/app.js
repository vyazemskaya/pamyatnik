(() => {
    ...
    (() => {
            ...
            const setTranslate = () => {
                ...
                for (let i = 0, length = slides.length; i < length; i += 1) {
                    ...
                    if (params.slideShadows) {
                        ...
                        if ($shadowBeforeEl.length === 0) $shadowBeforeEl = create_shadow_createShadow(params, $slideEl, isHorizontal ? "left" : "top");
                        if ($shadowAfterEl.length === 0) $shadowAfterEl = create_shadow_createShadow(params, $slideEl, isHorizontal ? "right" : "bottom");
            ...
            const setTranslate = () => {
                ...
                for (let i = 0; i < slides.length; i += 1) {
                    ...
                    if (custom && data.shadow || !custom) {
                        ...
                        if ($shadowEl.length === 0 && data.shadow) $shadowEl = create_shadow_createShadow(params, $slideEl);
                        if ($shadowEl.length) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".mainpage__catalog .chapter-section__slider")) new core(".mainpage__catalog .chapter-section__slider", {
            ...
            if (document.querySelector(".mainpage__materials .chapter-section__slider")) new core(".mainpage__materials .chapter-section__slider", {
                modules: [ Navigation, Grid ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".services-mainpage__slider")) {
                const initSwiper = () => {
                    if (window.matchMedia("(max-width: 768px)").matches && !mainpageServicesSlider) mainpageServicesSlider = new core(".services-mainpage__slider", {
                        modules: [ Autoplay ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".mainpage__articles .chapter-section__slider")) new core(".mainpage__articles .chapter-section__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".hero-optovikam__slider")) new core(".hero-optovikam__slider", {
            ...
            if (document.querySelector(".privileges-optovikam__slider")) if (window.matchMedia("(max-width: 768px)").matches && !optovikamPrivilegesSlider) optovikamPrivilegesSlider = new core(".privileges-optovikam__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".cooperation-optovikam__chapters")) if (window.matchMedia("(max-width: 768px)").matches && !optovikamChaptersSlider) optovikamChaptersSlider = new core(".cooperation-optovikam__chapters", {
                ...
                on: {}
            }); else if (!window.matchMedia("(max-width: 768px)").matches && optovikamChaptersSlider) {
            ...
            if (document.querySelector(".gallery__slider-v2")) new core(".gallery__slider-v2", {
                modules: [ Navigation, EffectCreative, EffectCoverflow ],
                loop: true,
                speed: 1e3,
                spaceBetween: 30,
            ...
            if (document.querySelector(".gallery__slider-v3")) new core(".gallery__slider-v3", {
            ...
            function getPreviousIndex(swiper) {
                ...
                document.getElementById("s").src = swiper.slides[previousIndex].querySelector("img").src;
                thumbs.forEach((thumb => {
                    thumb.classList.remove("_hidden");
                    if (thumb.querySelector("img").src === document.getElementById("s").src) thumb.classList.add("_hidden");
                }));
            }
            var galleryThumbs = new core(".hero-catalog__thumbs-slider", {
                observeParents: true,
                observer: true,
            ...
            if (document.querySelector(".article__chapter .chapter-section__slider")) new core(".article__chapter .chapter-section__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".about__activities .chapter-section__slider")) new core(".about__activities .chapter-section__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".product-main__slider-main")) {
                ...
                if (slides.length <= 1) {
                    ...
                    const productThumbs = new core(".product-main__slider-thumbs", {
                        modules: [ Thumb ],
                        slidesPerView: 1,
                        freeMode: true,
                        watchSlidesProgress: true
                    });
                    new core(".product-main__slider-main", {
        ...
        if (document.querySelector("#map")) {
            ...
            ymaps.ready([ "Panel" ]).then((function() {
                ...
                new Promise(((resolve, reject) => {
                    if (document.querySelector(".main.mainpage")) window.myObjects = ymaps.geoQuery({
                    ...
                    setTimeout((() => resolve(window.myObjects._objects.forEach((object => {
                        if (object.options._options.type === "mainOffice") {
                            document.querySelector(".customControl .content").innerHTML = object.options._options.balloonContent;
