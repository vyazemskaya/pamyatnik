(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".catalog-mainpage__slider")) new core(".catalog-mainpage__slider", {
            ...
            if (document.querySelector(".materials-mainpage__slider")) new core(".materials-mainpage__slider", {
                modules: [ Navigation, Grid ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".articles-mainpage__slider")) new core(".articles-mainpage__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
