(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery-optovikam__slider")) new swiper_core_Swiper(".gallery-optovikam__slider", {
            ...
            if (document.querySelector(".cooperation-optovikam__chapters")) if (window.matchMedia("(max-width: 768px)").matches && !optovikamChaptersSlider) optovikamChaptersSlider = new swiper_core_Swiper(".cooperation-optovikam__chapters", {
